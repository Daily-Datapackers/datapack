...
tp @e[type=area_effect_cloud,tag=c.cosmeticentity,tag=this,limit=1] ~ ~ ~
...
execute as @e[type=area_effect_cloud,tag=c.cosmeticentity,tag=this,limit=1] store result entity @s Air short 1 run time query gametime
