...
# Summon mashien controller / mashine model
...
# Builds Whack a Frog mashine
execute as @e[type=armor_stand,tag=whack_a_frog,tag=controller,tag=new] at @s run function minigames:whack_a_frog/mashine_parts/mashine
