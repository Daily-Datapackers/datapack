...
#Finish
execute as @e[type=armor_stand,tag=spawn_finish] at @s run function minigames:finish/place
execute as @e[type=armor_stand,tag=finish] at @s run function minigames:finish/main
