...
execute if data entity @s SelectedItem.tag{Setting:3} as @e[type=marker,tag=parkour,tag=selected] at @s run function tools:parkour/val_setter/actions/set_timer_1

execute if data entity @s SelectedItem.tag{Setting:4} as @e[type=marker,tag=parkour,tag=selected] at @s run function tools:parkour/val_setter/actions/set_timer_2
