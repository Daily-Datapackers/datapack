...
execute at @s if entity @e[type=marker,tag=checkpoint,limit=1,distance=..1] at @s run data modify entity @e[type=marker,tag=checkpoint,distance=..1,limit=1] Rotation set from entity @s Rotation
#Give you the spawnpoint based on markers
execute if entity @e[type=marker,tag=checkpoint,limit=1,distance=..1] at @s as @a[distance=..1] run function tools:dont_stop_running/checkpoint_setter/spawnpoint
