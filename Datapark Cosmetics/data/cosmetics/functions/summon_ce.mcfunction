...
summon area_effect_cloud ~ ~-3 ~ {Duration:2147483647,Tags:["c.cosmeticentity"],Passengers:[{id:"minecraft:armor_stand",Invisible:1b,Marker:1b,Pose:{Head:[0f,1f,0f]},Tags:["c.cosmeticarmorstand"]}]}
